...
const Resume = () => {
  return (
    <div className="cv-body z-50 overflow-y-auto overflow-x-auto bg-white">
        ...
        <div id="main">
          <div className="relative z-50 pb-[0.125in] pl-[0.3in] pt-[0.3in] ">
            ...
            <div className="mt-3 w-[47em] text-[12px] font-normal">
              ...
              knowledge and skills. Eager to further enhance and apply
              development skills to excel as a developer.
            </div>
          </div>
              ...
              <div className="details">
                ...
                <div>
                  ...
                  <ul>
                    ...
                    <li>
                      Developing, maintaining, and enhancing software solutions
          ...
          <section className="main-block pt-2">
            ...
            <section className="blocks">
              ...
              <div className="details">
                ...
                <div>
                  Utilize Blockchain to assist in validation by granting rights
                  to relevant logistics companies to update and share
                  ...
                  track the processes and steps involved in the work, aiding in
                  document management.
                </div>
              </div>
            </section>
            ...
            <section className="blocks">
              ...
              <div className="details">
                ...
                <div>
                  ...
                  This tool provides essential features to streamline the setup
                  of development environments and facilitates the testing of
