...
const Resume = () => {
  return (
    <div className="cv-body z-50 h-screen bg-white">
      <section id="main">
        <div className="relative z-50 pb-[0.125in] pl-[0.3in] pt-[0.3in] ">
          ...
          <div className="mt-3 w-[47em] text-[12px] font-normal">
            Computer Science graduate with a passion for technology and a keen
            interest in software development. I have experience in web
            development, and I enjoy exploring various fields to broaden my
            knowledge and skills. Eager to further enhance and apply development
            skills to excel as a developer.
          </div>
        </div>
        ...
        <section className="main-block pt-6">
          <h2>
            <FaSuitcase
              color="#E53935"
              size={18}
              className="absolute -left-[27.25px] z-10"
            ></FaSuitcase>
            ...
            <div className="details">
              <header>
                ...
                <span className="place">
                  <span className="font-bold text-blue-500"> ZUPPORTS </span>{' '}
                  (Startup from
                  <span className="font-bold text-red-500"> SCG</span> Zero to
                  One)
                </span>
              ...
              <div>
                ...
                <span className="font-bold"> Siam Cement Group (SCG) </span>{' '}
                that deliver digital transformation for B2B supply chain.
                <ul>
                  <li>
                    Building highly scalable web applications using Nuxt,
                    Laravel and AWS.
                  </li>
                  <li>
                  ...
                  <li>
                    ...
                    comprehensive understanding of problem requirements. Worked
                    collectively to design software solutions that precisely
                    aligned with the specified requirements. Proficient in
                    breaking down complex problems into technical tasks to
                    facilitate efficient development processes.
                  </li>
                </ul>
              </div>
            </div>
          ...
          <section className="blocks">
            ...
            <div className="details">
              ...
              <div>
                ...
                credibility of certificates and educational institution issuers.
                Also, we won the hackathon.
              </div>
            </div>
          </section>
          <section className="blocks">
            ...
            <div className="details">
              ...
              <div>
                ...
                relevant logistics companies to update and share information.
                Use tokens to confirm operations at various stages by awarding
                tokens to the operators in those specific stages. Utilize the
                transaction history of these tokens to track the processes and
                steps involved in the work, aiding in document management.
              </div>
            </div>
          </section>
          <section className="blocks">
            ...
            <div className="details">
              ...
              <div>
                ...
                ASEAN countries to find and solve the problem using SAP tools.
              </div>
            </div>
          </section>
        </section>
          ...
          <section className="blocks">
            ...
            <div className="details">
              <header>
                ...
                <span className="place">
                  Minifabric, Ansible, Docker, Node, Electron, Vue and Fabric
                  node SDK
                </span>
              </header>
              <div>
                A GUI application designed to assist developers in their journey
                of learning and developing with Hyperledger Fabric. This tool
                provides essential features to streamline the setup of
                development environments and facilitates the testing of
          ...
          <section className="blocks">
            ...
            <div className="details">
              ...
              <div>
                ...
                Intelligence, Machine Learning, Blockchain, Big Data Analysis,
                Design Pattern.
              </div>
            </div>
          </section>
          ...
          <section className="blocks">
            ...
            <div className="details">
              <header>
                ...
                <span className="place">Bodindecha (sing singhaseni) 2</span>
                <span className="location">Bangkok, Thailand</span>
              </header>
              <div>GPA 3.71</div>
            </div>
      ...
      <div id="sidebar">
        ...
        <div className="sidebar-background2"></div>
        <div className="sidebar-background3"></div>
        <div className="sidebar-background4"></div> */}
        ...
        >
          ...
          <div className="mb-1.5 mt-3 flex content-center align-middle">
            ...
            <div className="my-auto text-[10px]">pisichi.github.io/my-page</div>
          </div>
          ...
          <div className="mb-1.5 flex content-center align-middle">
            ...
            <div className="my-auto text-[10px]">github.com/pisichi</div>
          </div>
        ...
        <div className="relative z-10 mt-8" id="">
          ...
          <div className="mb-1 mt-3 !font-semibold italic">Experienced In:</div>
          ...
          <div className="mb-1 mt-4 !font-semibold italic">Exposure To:</div>
          <ul className="ml-2 list-disc text-[10px]">
            <li>Python</li>
            <li>MongoDB</li>
            <li>Electron</li>
